...
class FirstYearFirstSem extends StatefulWidget {
  const FirstYearFirstSem({Key? key}) : super(key: key);

  @override
  State<FirstYearFirstSem> createState() => _firstYearFirstSem();
}
class _firstYearFirstSem extends State<FirstYearFirstSem> {
